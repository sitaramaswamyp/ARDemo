...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color themeColor = const Color(0xFF8E6CEF);
  late Color themeAccent = const Color(0x6A8E6CEF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color themeColor = const Color(0xFF0770FA);
  late Color themeAccent = const Color(0xFFE0D1CD);
}
